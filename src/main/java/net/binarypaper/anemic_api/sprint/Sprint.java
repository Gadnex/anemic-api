...
public class Sprint {
    ...
    @Schema(description = "The unique identifier of the sprint", example = "8f82a93a-de1c-4c3d-b092-079092c6fb07")
    private UUID sprintId;

    @Version
    @JsonView({ Views.Read.class, Views.Update.class })
    @Schema(description = "The version of the sprint used for concurrency purposes when updating", example = "0")
    ...
    @Schema(description = "The unique identifier of the product that the sprint belongs to", example = "3fa85f64-5717-4562-b3fc-2c963f66afa6")
