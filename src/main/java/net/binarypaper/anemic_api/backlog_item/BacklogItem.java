...
public class BacklogItem {
  ...
  @Schema(
      description = "The unique identifier of the backlog item",
      example = "1fe4fa4a-c693-48ed-bcd1-73da1891fce9")
  private UUID backlogItemId;

  @Version
  @JsonView({Views.Read.class, Views.Update.class})
  @Schema(
      description = "The version of the backlog item used for concurrency purposes when updating",
      example = "0")
  ...
  @Schema(
      description = "The unique identifier of the product that the backlog item belongs to",
  ...
  @JsonView({Views.Read.class, Views.Create.class, Views.Update.class})
  @Schema(
      description = "The unique identifier of the sprint that the backlog item belongs to",
      example = "3fa85f64-5717-4562-b3fc-2c963f66afa6")
  ...
  @JsonView({Views.Read.class, Views.Create.class, Views.Update.class})
  @Schema(
      description = "The user story of the backlog item",
      example = "A story for Backlog Item 1")
