package net.binarypaper.anemic_api.backlog_item.infrastructure.api;
...
public class BacklogItemController {
    ...
    public BacklogItemReadResponse createBacklogItem(
        ...
        try {
            return backlogItemService.createBacklogItem(backlogItemCreateRequest);
    ...
    @GetMapping
    @Operation(summary = "Get all backlog items", description = """
            <b>As a</b> scrum team member<br>
    ...
    public BacklogItemReadResponse getBacklogItem(@PathVariable(name = "backlog-item-id") UUID backlogItemId) {
        return backlogItemService.getBacklogItem(new BacklogItemId(backlogItemId));
    }
    ...
    public void deleteBacklogItem(@PathVariable(name = "backlog-item-id") UUID backlogItemId) {
        backlogItemService.deleteBacklogItem(new BacklogItemId(backlogItemId));
    }

    @PutMapping("{backlog-item-id}/sprint")
    @Operation(summary = "Commit backlog item to a sprint", description = """
            <b>As a</b> scrum team member<br>
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "Backlog item cannot be committed to sprint", content = @Content),
            @ApiResponse(responseCode = "404", description = "Backlog item not found", content = @Content)
    })
    public BacklogItemReadResponse commitToSprint(@PathVariable(name = "backlog-item-id") UUID backlogItemId, @RequestBody @Valid SprintId sprintId) {
        try {
            return backlogItemService.commitToSprint(new BacklogItemId(backlogItemId), sprintId);
    ...
    @Operation(summary = "Change the progress status of a backlog item", description = """
            <b>As a</b> scrum team member<br>
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "Backlog item progress status could not be changed", content = @Content),
            @ApiResponse(responseCode = "404", description = "Backlog item not found", content = @Content)
    })
    public BacklogItemReadResponse changeProgressStatus(@PathVariable(name = "backlog-item-id") UUID backlogItemId, @RequestBody @Valid ProgressStatusChangeRequest progressStatusChangeRequest) {
        return backlogItemService.changeProgressStatus(new BacklogItemId(backlogItemId), progressStatusChangeRequest);
    }

    @PutMapping("{backlog-item-id}/comments")
    @Operation(summary = "Add a comment to a backlog item", description = """
            <b>As a</b> scrum team member<br>
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "Backlog item  comment could not be added", content = @Content),
            @ApiResponse(responseCode = "404", description = "Backlog item not found", content = @Content)
    })
    public BacklogItemReadResponse addComment(@PathVariable(name = "backlog-item-id") UUID backlogItemId, @RequestBody @Valid AddCommentRequest addCommentRequest) {
        return backlogItemService.addComment(new BacklogItemId(backlogItemId), addCommentRequest);
    }
}
